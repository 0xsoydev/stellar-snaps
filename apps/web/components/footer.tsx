      ...
      <div className="relative z-10 px-6 sm:px-12 pt-20 sm:pt-32 pb-8 flex flex-col justify-between flex-1">
        ...
        <div className="font-inter-italic border-t border-white/20 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center text-sm font-medium text-neutral-400 gap-4">
          ...
          <div className="flex gap-6">
            <a href="https://x.com/stellarsnapsxyz" target="_blank" rel="noopener noreferrer" className="font-bricolage hover:text-white transition-colors flex items-center gap-2">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
              X
            </a>
            <a href="https://github.com/0xsoydev/stellar-snaps" target="_blank" rel="noopener noreferrer" className="font-bricolage hover:text-white transition-colors flex items-center gap-2">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
